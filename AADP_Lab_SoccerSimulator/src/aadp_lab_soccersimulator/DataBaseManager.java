...
public class DataBaseManager {
    ...
    public DataBaseManager(String dbName, String[] teams, String DB_URL, String USER, String PASS) throws ClassNotFoundException, InstantiationException, IllegalAccessException {
        this.dbName = dbName;
        this.teams = teams;
        this.DB_URL = DB_URL;
        this.USER = USER;
